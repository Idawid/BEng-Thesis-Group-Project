...
class TimeSeriesModel:
    ...
    def trainModel(self, inputSize, thetaSize, horizon, nNeurons, nLayers, nStacks, train_dataset, nEpocks, test_dataset):
    ...
    def prepareDataForPrediction(self, df, batch_size, window_size):
        ...
        X_all = df_for_pred.drop(["Price"], axis=1).dropna().to_numpy() # only want prices, our future model can be a univariate model
